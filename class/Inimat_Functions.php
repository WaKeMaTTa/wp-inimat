...
class Inimat_Functions
{
     ...
     *  @return string
     */
    function msg($msg, $type_msg) { // $type_msg => 'correct' , 'warning' , 'close'
	 ...
	 *  @return string $html
	 */
	function html_search_creature($current = NULL) {
		/*
	<p class="search-box">
	<label class="screen-reader-text" for="post-search-input">Buscar entradas:</label>
	<input type="search" id="post-search-input" name="s" value="">
	<input type="submit" name="" id="search-submit" class="button" value="Buscar entradas"></p>
	*/	
		$html = '<p class="search-box">';
			$html .= '<label class="screen-reader-text" for="creature-search-input">' . __('Search creature:', 'wpinimat_languages') . '</label>';
			$html .= '<input type="search" id="creature-search-input" name="s" value="">';
			$html .= '<input type="submit" name="" id="search-submit" class="button" value="' . __('Search creature:', 'wpinimat_languages') . '">';
		$html .= '</p>';
